...
public class SourcePredicates {
    ...
    private static final PatternPredicate MAVEN_TEST_PATTERN =
            new PatternPredicate(".*/target/test-classes/.*");
    private static final PatternPredicate INTELLIJ_TEST_PATTERN =
            new PatternPredicate(".*/out/test/classes/.*");

    private static final Predicate<String> TEST_PATTERN =
            MAVEN_TEST_PATTERN.or(INTELLIJ_TEST_PATTERN);
    private static final Predicate<String> PRODUCTION_PATTERN = TEST_PATTERN.negate();
