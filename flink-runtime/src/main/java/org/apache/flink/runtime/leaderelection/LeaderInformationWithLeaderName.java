...
public final class LeaderInformationWithLeaderName {
    private final String leaderName;

    private final LeaderInformation leaderInformation;

    private LeaderInformationWithLeaderName(
    ...
    public static LeaderInformationWithLeaderName create(
            String leaderName, LeaderInformation leaderInformation) {
        return new LeaderInformationWithLeaderName(leaderName, leaderInformation);
    }
}
