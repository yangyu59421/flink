...
public class LimitableBulkFormatTest {
    ...
    public void test() throws IOException {
        ...
        BulkFormat<String, FileSourceSplit> format =
                LimitableBulkFormat.create(new StreamFormatAdapter<>(new TextLineInputFormat()), 22L);
    ...
    public void testLimitOverBatches() throws IOException {
        ...
        // read
        BulkFormat<String, FileSourceSplit> format =
                LimitableBulkFormat.create(new StreamFormatAdapter<>(new TextLineInputFormat()), limit);
