...
/** Factory for {@link KubernetesSingleLeaderElectionHaServices}. */
public class KubernetesSingleLeaderElectionHaServicesFactory
    ...
    public HighAvailabilityServices createHAServices(Configuration configuration, Executor executor)
            throws Exception {
        return new KubernetesSingleLeaderElectionHaServices(
